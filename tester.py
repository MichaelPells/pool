...
# print(result.count)
x = Numbers.max("id", db, "Table1")
db.update("Table1", {"id": 200}, record={"phone": Var.escape(x)})
result = db.read("Table1", {"phone": Var.escape(x)})
print(result.get(row=0, column="phone").compute().compute())
print(result.count)