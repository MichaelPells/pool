...
# print(result.count)
db.update("Table1", {"surname": "Akinpelumi"}, record={"surname": "YYYYY", "gender": "XXXXX"})
# db.update("Table1", {"id": 300}, record={"isstudent": Field(300, "gender")})
db.undo()
result = db.read("Table1", {"surname": "Akinpelumi"})
print(result.get())
